...
public class PromotionCode2PricingStrategy implements PromotionPricingStrategy {
    ...
    public PromotionCode2PricingStrategy(RecycleCategoryRepository recycleCategoryRepository, PromotionRepository promotionRepository, RecycleItemRepository recycleItemRepository) {
