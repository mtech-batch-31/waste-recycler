...
public class PromotionCode3PricingStrategy implements PromotionPricingStrategy {
    ...
    public PromotionCode3PricingStrategy(RecycleCategoryRepository recycleCategoryRepository, PromotionRepository promotionRepository, RecycleItemRepository recycleItemRepository) {
    ...
    public BigDecimal calculateTotalPrice(List<Category> categories, String promoCode, List<Item> items) {
        ...
        if (StringUtils.hasText(promoCode)) {
            ...
            totalPrice = totalPrice.multiply(BigDecimal.valueOf(1.8));
        }
        return totalPrice;
    }
}
